$.Class("AC.MC", {
	...
	addRich : function(name, val, enable, decor, fac, isEqual){		
		new AC.Rich(this, name, val, enable, decor, fac, isEqual);
		return this;
	},
	...
	srcVal : function(name){
		return this.varExprX(name).srcVal;
	},
